...
const perguntas = [
    {
        enunciado: "Você é a favor das cotas raciais?"
        alternativas: [
            {
                texto: "sim.",
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "Sim, porque ele serve como inclusão e reparação."
    ...
    {
        enunciado: "Você usaria o sistema de cotas raciais?",
        alternativas: [
            {
                texto: "Sim, pois apresenta vários benefícios",
